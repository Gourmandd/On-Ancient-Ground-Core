...
public class CoreMetals
{
    ...
    public enum MetalType implements StringRepresentable, RegistryMetal
    {
        ...
        ALUMINIUM(0xCDD6DA, MapColor.COLOR_LIGHT_BLUE, Rarity.RARE, -1, TFCTiers.BISMUTH_BRONZE), ALUMINIUM_BRONZE(MapColor.COLOR_LIGHT_BLUE, Rarity.RARE, -1, TFCTiers.BLACK_BRONZE), CAST_IRON_ALLOY(MapColor.COLOR_LIGHT_BLUE, Rarity.UNCOMMON, -1, TFCTiers.WROUGHT_IRON), HARDENED_STEEL(MapColor.COLOR_LIGHT_BLUE, Rarity.RARE, -1, TFCTiers.STEEL), NETHERSTEEL(MapColor.COLOR_LIGHT_BLUE, Rarity.EPIC, -1, TFCTiers.RED_STEEL), LEAD(0x37304a, MapColor.COLOR_PURPLE, Rarity.COMMON, -1, TFCTiers.COPPER), ELECTRUM(0xf4d985, MapColor.COLOR_LIGHT_BLUE, Rarity.COMMON, -1, TFCTiers.COPPER);
    ...
    public enum PartType
    {
        ...
        BASE_OXIDIZED, EQUIPMENT_OXIDIZED
    }

    public enum BlockType implements StringRepresentable
    {
        CUT_BLOCK(PartType.BASE, block(IWeatheringBlock.Age.NONE)), EXPOSED_CUT_BLOCK(PartType.BASE_OXIDIZED, block(IWeatheringBlock.Age.EXPOSED)), WEATHERED_CUT_BLOCK(PartType.BASE_OXIDIZED, block(IWeatheringBlock.Age.WEATHERED)), OXIDIZED_CUT_BLOCK(PartType.BASE_OXIDIZED, block(IWeatheringBlock.Age.OXIDIZED)), CUT_BLOCK_SLAB(PartType.BASE, slab(IWeatheringBlock.Age.NONE)), EXPOSED_CUT_BLOCK_SLAB(PartType.BASE_OXIDIZED, slab(IWeatheringBlock.Age.EXPOSED)), WEATHERED_CUT_BLOCK_SLAB(PartType.BASE_OXIDIZED, slab(IWeatheringBlock.Age.WEATHERED)), OXIDIZED_CUT_BLOCK_SLAB(PartType.BASE_OXIDIZED, slab(IWeatheringBlock.Age.OXIDIZED)), CUT_BLOCK_STAIRS(PartType.BASE, stairs(Metal.BlockType.BLOCK, IWeatheringBlock.Age.NONE)), EXPOSED_CUT_BLOCK_STAIRS(PartType.BASE_OXIDIZED, stairs(Metal.BlockType.EXPOSED_BLOCK, IWeatheringBlock.Age.EXPOSED)), WEATHERED_CUT_BLOCK_STAIRS(PartType.BASE_OXIDIZED, stairs(Metal.BlockType.WEATHERED_BLOCK, IWeatheringBlock.Age.WEATHERED)), OXIDIZED_CUT_BLOCK_STAIRS(PartType.BASE_OXIDIZED, stairs(Metal.BlockType.OXIDIZED_BLOCK, IWeatheringBlock.Age.OXIDIZED));
