...
{
    CHESTNUT_NOXWOOD(SpectrumWoodType.NOXWOOD, MapColor.CRIMSON_NYLIUM, MapColor.CRIMSON_NYLIUM, SpectrumConfiguredFeatureKeys.CHESTNUT_NOXFUNGUS), SLATE_NOXWOOD(SpectrumWoodType.NOXWOOD, MapColor.COLOR_GRAY, MapColor.COLOR_GRAY, SpectrumConfiguredFeatureKeys.SLATE_NOXFUNGUS), EBONY_NOXWOOD(SpectrumWoodType.NOXWOOD, MapColor.TERRACOTTA_BLACK, MapColor.TERRACOTTA_BLACK, SpectrumConfiguredFeatureKeys.EBONY_NOXFUNGUS), IVORY_NOXWOOD(SpectrumWoodType.NOXWOOD, MapColor.QUARTZ, MapColor.QUARTZ, SpectrumConfiguredFeatureKeys.IVORY_NOXFUNGUS), WEEPING_GALA(SpectrumWoodType.WEEPING_GALA, MapColor.COLOR_BROWN, MapColor.COLOR_BROWN, SpectrumTreeGrowers.WEEPING_GALA_SAPLING_GENERATOR), WHITE(SpectrumWoodType.COLORED_TREE, MapColor.SNOW, MapColor.SNOW, SpectrumTreeGrowers.WHITE_COLORED_SAPLING_GENERATOR), ORANGE(SpectrumWoodType.COLORED_TREE, MapColor.COLOR_ORANGE, MapColor.COLOR_ORANGE, SpectrumTreeGrowers.ORANGE_COLORED_SAPLING_GENERATOR), MAGENTA(SpectrumWoodType.COLORED_TREE, MapColor.COLOR_MAGENTA, MapColor.COLOR_MAGENTA, SpectrumTreeGrowers.MAGENTA_COLORED_SAPLING_GENERATOR), LIGHT_BLUE(SpectrumWoodType.COLORED_TREE, MapColor.COLOR_LIGHT_BLUE, MapColor.COLOR_LIGHT_BLUE, SpectrumTreeGrowers.LIGHT_BLUE_COLORED_SAPLING_GENERATOR), YELLOW(SpectrumWoodType.COLORED_TREE, MapColor.COLOR_YELLOW, MapColor.COLOR_YELLOW, SpectrumTreeGrowers.YELLOW_COLORED_SAPLING_GENERATOR), LIME(SpectrumWoodType.COLORED_TREE, MapColor.COLOR_LIGHT_GREEN, MapColor.COLOR_LIGHT_GREEN, SpectrumTreeGrowers.LIME_COLORED_SAPLING_GENERATOR), PINK(SpectrumWoodType.COLORED_TREE, MapColor.COLOR_PINK, MapColor.COLOR_PINK, SpectrumTreeGrowers.PINK_COLORED_SAPLING_GENERATOR), GRAY(SpectrumWoodType.COLORED_TREE, MapColor.COLOR_GRAY, MapColor.COLOR_GRAY, SpectrumTreeGrowers.GRAY_COLORED_SAPLING_GENERATOR), LIGHT_GRAY(SpectrumWoodType.COLORED_TREE, MapColor.COLOR_LIGHT_GRAY, MapColor.COLOR_LIGHT_GRAY, SpectrumTreeGrowers.LIGHT_GRAY_COLORED_SAPLING_GENERATOR), CYAN(SpectrumWoodType.COLORED_TREE, MapColor.COLOR_CYAN, MapColor.COLOR_CYAN, SpectrumTreeGrowers.CYAN_COLORED_SAPLING_GENERATOR), PURPLE(SpectrumWoodType.COLORED_TREE, MapColor.COLOR_PURPLE, MapColor.COLOR_PURPLE, SpectrumTreeGrowers.PURPLE_COLORED_SAPLING_GENERATOR), BLUE(SpectrumWoodType.COLORED_TREE, MapColor.COLOR_BLUE, MapColor.COLOR_BLUE, SpectrumTreeGrowers.BLUE_COLORED_SAPLING_GENERATOR), BROWN(SpectrumWoodType.COLORED_TREE, MapColor.COLOR_BROWN, MapColor.COLOR_BROWN, SpectrumTreeGrowers.BROWN_COLORED_SAPLING_GENERATOR), GREEN(SpectrumWoodType.COLORED_TREE, MapColor.COLOR_GREEN, MapColor.COLOR_GREEN, SpectrumTreeGrowers.GREEN_COLORED_SAPLING_GENERATOR), RED(SpectrumWoodType.COLORED_TREE, MapColor.COLOR_RED, MapColor.COLOR_RED, SpectrumTreeGrowers.RED_COLORED_SAPLING_GENERATOR), BLACK(SpectrumWoodType.COLORED_TREE, MapColor.COLOR_BLACK, MapColor.COLOR_BLACK, SpectrumTreeGrowers.BLACK_COLORED_SAPLING_GENERATOR);
    ...
    public boolean hasBlockType(Wood.BlockType type)
    {
        return switch (type)
        {
            case TWIG, SEWING_TABLE, SCRIBING_TABLE, VERTICAL_SUPPORT, HORIZONTAL_SUPPORT, LOOM, TOOL_RACK, SLUICE,
                 SHELF, SAPLING, CRATE, BARREL -> true;
            default -> false;
        };
    }
    ...
    {
        NOXWOOD, WEEPING_GALA, COLORED_TREE
    }
}
