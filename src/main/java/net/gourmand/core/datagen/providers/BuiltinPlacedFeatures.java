...
public class BuiltinPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> AMETHYST_GEODE = createKey(AncientGroundCore.MODID, "vein/geode/amethyst");
    public static final ResourceKey<PlacedFeature> CITRINE_GEODE = createKey(AncientGroundCore.MODID, "vein/geode/citrine");
    public static final ResourceKey<PlacedFeature> TOPAZ_GEODE = createKey(AncientGroundCore.MODID, "vein/geode/topaz");
    public static final ResourceKey<PlacedFeature> ONYX_GEODE = createKey(AncientGroundCore.MODID, "vein/geode/onyx");
    public static final ResourceKey<PlacedFeature> MOONSTONE_GEODE = createKey(AncientGroundCore.MODID, "vein/geode/moonstone");

    public static final ResourceKey<PlacedFeature> BISMUTH_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/bismuth");
    public static final ResourceKey<PlacedFeature> BORAX_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/borax");
    public static final ResourceKey<PlacedFeature> CASSITERITE_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/cassiterite");
    public static final ResourceKey<PlacedFeature> CINNABAR_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/cinnabar");
    public static final ResourceKey<PlacedFeature> CRYOLITE_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/cryolite");
    public static final ResourceKey<PlacedFeature> DIAMOND_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/diamond");
    public static final ResourceKey<PlacedFeature> EMERALD_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/emerald");
    public static final ResourceKey<PlacedFeature> GARNIERITE_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/garnierite");
    public static final ResourceKey<PlacedFeature> GRAPHITE_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/graphite");
    public static final ResourceKey<PlacedFeature> GYPSUM_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/gypsum");
    public static final ResourceKey<PlacedFeature> HALITE_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/halite");
    public static final ResourceKey<PlacedFeature> HEMATITE_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/hematite");
    public static final ResourceKey<PlacedFeature> KAOLINITE_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/kaolinite");
    public static final ResourceKey<PlacedFeature> LAPIS_LAZULI_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/lapis_lazuli");
    public static final ResourceKey<PlacedFeature> LIGNITE_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/lignite");
    public static final ResourceKey<PlacedFeature> LIMONITE_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/limonite");
    public static final ResourceKey<PlacedFeature> MALACHITE_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/malachite");
    public static final ResourceKey<PlacedFeature> NATIVE_COPPER_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/native_copper");
    public static final ResourceKey<PlacedFeature> NATIVE_GOLD_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/native_gold");
    public static final ResourceKey<PlacedFeature> NATIVE_SILVER_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/native_silver");
    public static final ResourceKey<PlacedFeature> OPAL_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/opal");
    public static final ResourceKey<PlacedFeature> PALTAERIA_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/paltaeria");
    public static final ResourceKey<PlacedFeature> RUBY_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/ruby");
    public static final ResourceKey<PlacedFeature> SALTPETER_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/saltpeter");
    public static final ResourceKey<PlacedFeature> SAPPHIRE_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/sapphite");
    public static final ResourceKey<PlacedFeature> SHIMERSTONE_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/shimmerstone");
    public static final ResourceKey<PlacedFeature> SPHALERITE_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/sphalerite");
    public static final ResourceKey<PlacedFeature> STRATINE_DEEPER_DOWN = createKey(AncientGroundCore.MODID, "vein/deeper_down/stratine");
