...
public class BuiltinBlockTags extends TagsProvider<Block> implements Accessors
{
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        addMultiBlockOre(Ore.LIGNITE, TFCBlocks.LIGNITE.key());
        addMultiBlockOre(Ore.BITUMINOUS_COAL, TFCBlocks.BITUMINOUS_COAL.key());
        addMultiBlockOre(CoreOres.ANTHRACITE, CoreBlocks.BASIC_ORES.get(CoreOres.ANTHRACITE).getKey());

        addMultiBlockOre(CoreOres.BAUXITE, CoreBlocks.BASIC_ORES.get(CoreOres.BAUXITE).getKey());
        ...
        addMultiBlockOre(Ore.HALITE, TFCBlocks.HALITE.key());
    ...
    protected void addMultiBlockOre(CoreOres ore, ResourceKey<Block> key){
        this.tag(CoreTags.Blocks.CORE_ORE_MULTIBLOCK.get(ore)).add(key);
    }

    protected void addMultiBlockOre(Ore ore, ResourceKey<Block> key){
        this.tag(CoreTags.Blocks.TFC_ORE_MULTIBLOCK.get(ore)).add(key);
    }
    ...
    protected void addMultiBlockOre(CoreOres ore, List<RegistryRock> rocks){
        ...
        for (RegistryRock rock : rocks){
            if (rock instanceof CoreRocks){
                if (ore.isGraded()){
                    this.tag(CoreTags.Blocks.CORE_ORE_MULTIBLOCK.get(ore)).add(CoreBlocks.CUSTOM_ROCK_GRADED_ORES.get(rock).get(ore).get(CoreOres.Grade.RICH).getKey());
                } else {
                    this.tag(CoreTags.Blocks.CORE_ORE_MULTIBLOCK.get(ore)).add(CoreBlocks.CUSTOM_ROCK_ORES.get(rock).get(ore).getKey());
                }
            }
            if (rock instanceof Rock) {
                if (ore.isGraded()){
                    this.tag(CoreTags.Blocks.CORE_ORE_MULTIBLOCK.get(ore)).add(CoreBlocks.GRADED_ORES.get(rock).get(ore).get(CoreOres.Grade.RICH).getKey());
                } else {
                    this.tag(CoreTags.Blocks.CORE_ORE_MULTIBLOCK.get(ore)).add(CoreBlocks.ORES.get(rock).get(ore).getKey());
                }
            }
        }
    }
    ...
    protected void addMultiBlockOre(Ore ore, List<RegistryRock> rocks){
        ...
        for (RegistryRock rock : rocks){
            if (rock instanceof CoreRocks){
                if (ore.isGraded()){
                    this.tag(CoreTags.Blocks.TFC_ORE_MULTIBLOCK.get(ore)).add(CoreBlocks.CUSTOM_ROCK_TFC_GRADED_ORES.get(rock).get(ore).get(CoreOres.Grade.RICH).getKey());
                } else {
                    this.tag(CoreTags.Blocks.TFC_ORE_MULTIBLOCK.get(ore)).add(CoreBlocks.CUSTOM_ROCK_TFC_ORES.get(rock).get(ore).getKey());
                }
            }
            if (rock instanceof Rock) {
                if (ore.isGraded()){
                    this.tag(CoreTags.Blocks.TFC_ORE_MULTIBLOCK.get(ore)).add(TFCBlocks.GRADED_ORES.get(rock).get(ore).get(Ore.Grade.RICH).key());
                } else {
                    this.tag(CoreTags.Blocks.TFC_ORE_MULTIBLOCK.get(ore)).add(TFCBlocks.ORES.get(rock).get(ore).key());
                }
            }
        }
    }
