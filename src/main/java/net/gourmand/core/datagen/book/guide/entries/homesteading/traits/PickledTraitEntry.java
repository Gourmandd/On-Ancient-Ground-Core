...
public class PickledTraitEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        this.page("page2", () -> BookBarrelSealedPageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(TerraFirmaCraft.MOD_ID, "barrel/pickled")));
