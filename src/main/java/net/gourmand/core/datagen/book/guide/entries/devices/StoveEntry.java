...
public class StoveEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        // page 2: interface.
        this.page("page2", () -> BookCraftingRecipePageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(TerraFirmaCraft.MOD_ID, "crafting/stove")));
