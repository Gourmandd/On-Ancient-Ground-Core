...
public class BarsEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        // page 1: explain bars.
        this.page("page1", () -> BookSpotlightPageModel.create().withTitle(this.context().pageTitle()).withText(this.context().pageText()).withItem(Ingredient.of(TFCBlocks.METALS.get(Metal.COPPER).get(Metal.BlockType.BARS))));
        ...
        this.page("page2", () -> BookAnvilWorkingPageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(TerraFirmaCraft.MOD_ID, "anvil/metal/bars/copper")).withRecipeId2(ResourceLocation.fromNamespaceAndPath(TerraFirmaCraft.MOD_ID, "anvil/metal/bars/copper_double")));
