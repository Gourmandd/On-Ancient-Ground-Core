...
public class IntroductionEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        this.page("page1", () -> BookSpotlightPageModel.create().withTitle(this.context().pageTitle()).withText(this.context().pageText()).withItem(Ingredient.of(Items.ENCHANTED_BOOK)));
        ...
        this.page("page2", () -> BookMultiblockPageModel.create().withMultiblockId(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "getting_started/stick_and_stones")).withText(this.context().pageText()).withVisualizeButton(false));
        ...
        this.page("page3", () -> BookSpotlightPageModel.create().withTitle(this.context().pageTitle()).withText(this.context().pageText()).withItem(Ingredient.of(TFCTags.Items.STONES_LOOSE)));
        ...
        // page 4: knapping GUI.
        this.page("page4", () -> BookImagePageModel.create().withTitle(this.context().pageTitle()).withText(this.context().pageText()).withImages(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "textures/book/getting_started/rock_knapping.png")));
        ...
        this.page("page5", () -> BookSpotlightPageModel.create().withTitle(this.context().pageTitle()).withText(this.context().pageText()).withItem(Ingredient.of(TFCTags.Items.TOOLS_STONE)));
        ...
        this.page("page6", () -> BookKnappingPageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(TerraFirmaCraft.MOD_ID, "knapping/stone/axe_head/metamorphic")));
        ...
        this.page("page7", () -> BookTextPageModel.create().withText(this.context().pageText()));
        ...
        this.page("page8", () -> BookCraftingRecipePageModel.create().withRecipeId1("tfc:crafting/stone/knife/sedimentary").withRecipeId2("tfc:crafting/stone/axe/sedimentary"));
    }
