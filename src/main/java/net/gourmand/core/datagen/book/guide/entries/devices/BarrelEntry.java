...
public class BarrelEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        this.page("page1", () -> BookSpotlightPageModel.create().withTitle(this.context().pageTitle()).withText(this.context().pageText()).withItem(Ingredient.of(TFCTags.Items.BARRELS)));
        ...
        this.page("page2", () -> BookCraftingRecipePageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(TerraFirmaCraft.MOD_ID, "crafting/wood/barrel/ash")));
        ...
        // page 4: interface.
        this.page("page4", () -> BookImagePageModel.create().withText(this.context().pageText()).withImages(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "textures/book/homesteading/barrel_interface.png")));
        ...
        this.page("page6", () -> BookTextPageModel.create().withText(this.context().pageText()).withTitle(this.context.pageTitle()));
        ...
        this.page("page7", () -> BookBarrelInstantPageModel.create().withText(this.context().pageText()).withTitle1("Limewater").withRecipeId1(ResourceLocation.fromNamespaceAndPath(TerraFirmaCraft.MOD_ID, "barrel/limewater")).withRecipeId2(ResourceLocation.fromNamespaceAndPath(TerraFirmaCraft.MOD_ID, "barrel/clay_ball")));
        ...
        this.page("page8", () -> BookBarrelSealedPageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(TerraFirmaCraft.MOD_ID, "barrel/jute_fiber")).withRecipeId2(ResourceLocation.fromNamespaceAndPath(TerraFirmaCraft.MOD_ID, "barrel/glue")));
        ...
        this.page("page9", () -> BookSpotlightPageModel.create().withText(this.context().pageText()).withItem(TFCItems.WOODEN_BUCKET));
        ...
        this.page("page10", () -> BookBarrelFluidInstantPageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(TerraFirmaCraft.MOD_ID, "barrel/brine")).withTitle1(this.context().pageTitle()));
        ...
        // page 11: barrel tips.
        this.page("page11", () -> BookTextPageModel.create().withText(this.context().pageText()));
        ...
        this.page("page12", () -> BookImagePageModel.create().withText(this.context().pageText()).withImages(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "textures/book/homesteading/barrel_drip.png")));
