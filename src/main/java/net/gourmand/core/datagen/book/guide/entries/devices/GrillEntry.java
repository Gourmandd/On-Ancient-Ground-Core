...
public class GrillEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        this.page("page1", () -> BookAnvilWorkingPageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(TerraFirmaCraft.MOD_ID, "anvil/wrought_iron_grill")));
        ...
        // page 2: interface.
        this.page("page2", () -> BookImagePageModel.create().withText(this.context().pageText()).withImages(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "textures/book/devices/grill_interface.png")));
