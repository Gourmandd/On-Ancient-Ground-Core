...
public class ExcavatingToolsEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        this.page("page1", () -> BookSpotlightPageModel.create().withTitle(this.context().pageTitle()).withText(this.context().pageText()).withItem(Ingredient.of(ModItems.SLEDGEHAMMERS.get(Metal.BRONZE).get())));
        ...
        // page 2: anvil recipe.
        this.page("page2", () -> BookAnvilWorkingPageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(HammerTime.MOD_ID, "anvil/metal/sledgehammer_head/wrought_iron")).withRecipeId2(ResourceLocation.fromNamespaceAndPath(HammerTime.MOD_ID, "anvil/metal/sledgehammer_head/steel")));
        ...
        // page 3: anvil recipe.
        this.page("page3", () -> BookAnvilWorkingPageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(HammerTime.MOD_ID, "anvil/metal/excavator_head/wrought_iron")).withRecipeId2(ResourceLocation.fromNamespaceAndPath(HammerTime.MOD_ID, "anvil/metal/excavator_head/steel")));
