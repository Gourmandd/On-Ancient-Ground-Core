...
public class AnvilEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        // page 2: making it
        this.page("page2", () -> BookCraftingRecipePageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(TerraFirmaCraft.MOD_ID, "crafting/metal/anvil/copper")));
