...
public class CellarEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        this.page("page1", () -> BookSpotlightPageModel.create().withTitle(this.context().pageTitle()).withText(this.context().pageText()).withItem(Ingredient.of(FLBlocks.SEALED_BRICKS)));
        ...
        this.page("page2", () -> BookCraftingRecipePageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(FirmaLife.MOD_ID, "crafting/sealed_bricks")).withRecipeId2(ResourceLocation.fromNamespaceAndPath(FirmaLife.MOD_ID, "crafting/sealed_brick_door")));
        ...
        // page 4: interface.
        this.page("page4", () -> BookMultiblockPageModel.create().withText(this.context().pageText()).withVisualizeButton(false).withMultiblockId(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "homesteading/cellar")));
