...
public class GlassblowingToolsEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        this.page("page3", () -> BookSpotlightPageModel.create().withTitle(this.context().pageTitle()).withText(this.context().pageText()).withItem(Ingredient.of(TFCItems.JACKS)));
        ...
        this.page("page4", () -> BookSpotlightPageModel.create().withTitle(this.context().pageTitle()).withText(this.context().pageText()).withItem(Ingredient.of(TFCItems.PADDLE)));
