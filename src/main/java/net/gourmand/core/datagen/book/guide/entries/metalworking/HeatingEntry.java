...
public class HeatingEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        this.page("page2", () -> BookImagePageModel.create().withText(this.context().pageText()).withImages(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "textures/book/metalworking/charcoal_forge_interface.png")));
