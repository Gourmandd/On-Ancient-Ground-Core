...
public class FoodShelfEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        this.page("page2", () -> BookCraftingRecipePageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(FirmaLife.MOD_ID, "crafting/wood/food_shelf/ash")));
