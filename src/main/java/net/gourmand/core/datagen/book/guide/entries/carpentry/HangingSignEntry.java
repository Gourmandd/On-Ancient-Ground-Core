...
public class HangingSignEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        this.page("page1", () -> BookSpotlightPageModel.create().withTitle(this.context().pageTitle()).withText(this.context().pageText()).withItem(Ingredient.of(TFCItems.HANGING_SIGNS.get(Wood.ASH).get(Metal.COPPER))));
        ...
        this.page("page2", () -> BookCraftingRecipePageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(TerraFirmaCraft.MOD_ID, "crafting/wood/hanging_sign/copper/ash")));
