...
public class CharcoalPitEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        // page 2: making it
        this.page("page2", () -> BookMultiblockPageModel.create().withText(this.context().pageText()).withMultiblockId(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "metalworking/charcoal_pit")));
        ...
        this.page("page3", () -> BookSpotlightPageModel.create().withTitle(this.context().pageTitle()).withText(this.context().pageText()).withItem(Ingredient.of(Items.CHARCOAL)));
        ...
        // page 4: making it
        this.page("page4", () -> BookMultiblockPageModel.create().withText(this.context().pageText()).withMultiblockId(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "metalworking/charcoal_pit_finished")));
