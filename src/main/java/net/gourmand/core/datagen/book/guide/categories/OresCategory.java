...
public class OresCategory extends CategoryProvider
{
    ...
    {
        return new String[]{"w__a__m__dei", "x__b__k__fgh", "y__c__l___j_", "_____________", "Kz_nopqrstuv", "LA_GCDEFBHIJ",};
    }
    ...
    protected void generateEntries()
    {
        ...
        // copper
        var nativeCopperEntry = createOreEntry("native_copper", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.NATIVE_COPPER), TFCItems.GRADED_ORES.get(Ore.NATIVE_COPPER).get(Ore.Grade.RICH).get(), "a", """
        ...
        var malachiteEntry = createOreEntry("malachite", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.MALACHITE), TFCItems.GRADED_ORES.get(Ore.MALACHITE).get(Ore.Grade.RICH).get(), "b", """
        ...
        var tetrahedriteEntry = createOreEntry("tetrahedrite", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.TETRAHEDRITE), TFCItems.GRADED_ORES.get(Ore.TETRAHEDRITE).get(Ore.Grade.RICH).get(), "c", """
        ...
        var nativeGoldEntry = createOreEntry("native_gold", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.NATIVE_GOLD), TFCItems.GRADED_ORES.get(Ore.NATIVE_GOLD).get(Ore.Grade.RICH).get(), "d", """
        ...
        var nativeSilverEntry = createOreEntry("native_silver", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.NATIVE_SILVER), TFCItems.GRADED_ORES.get(Ore.NATIVE_SILVER).get(Ore.Grade.RICH).get(), "e", """
        ...
        var cassiteriteEntry = createOreEntry("cassiterite", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.CASSITERITE), TFCItems.GRADED_ORES.get(Ore.CASSITERITE).get(Ore.Grade.RICH).get(), "f", """
        ...
        var bismuthiniteEntry = createOreEntry("bismuthinite", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.BISMUTHINITE), TFCItems.GRADED_ORES.get(Ore.BISMUTHINITE).get(Ore.Grade.RICH).get(), "g", """
        ...
        var garnieriteEntry = createOreEntry("garnierite", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.GARNIERITE), TFCItems.GRADED_ORES.get(Ore.GARNIERITE).get(Ore.Grade.RICH).get(), "h", """
        ...
        var galenaEntry = createOreEntry("galena", CoreTags.Items.CORE_ORE_MULTIBLOCK.get(CoreOres.GALENA), CoreItems.GRADED_ORES.get(CoreOres.GALENA).get(CoreOres.Grade.RICH).get(), "i", """
        ...
        var sphaleriteEntry = createOreEntry("sphalerite", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.SPHALERITE), TFCItems.GRADED_ORES.get(Ore.SPHALERITE).get(Ore.Grade.RICH).get(), "j", """
        ...
        // iron
        var magnetiteEntry = createOreEntry("magnetite", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.MAGNETITE), TFCItems.GRADED_ORES.get(Ore.MAGNETITE).get(Ore.Grade.RICH).get(), "k", """
                Magnetite is an ore of **Iron** metal. \s
                \\
                It can be found in large veins in any **Sedimentary** rocks near the surface.
                """);

        var limoniteEntry = createOreEntry("limonite", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.LIMONITE), TFCItems.GRADED_ORES.get(Ore.LIMONITE).get(Ore.Grade.RICH).get(), "l", """
                Limonite is an ore of **Iron** metal. \s
                \\
                It can be found in large veins in any **Sedimentary** rocks near the surface.
                """);

        var hematiteEntry = createOreEntry("hematite", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.HEMATITE), TFCItems.GRADED_ORES.get(Ore.HEMATITE).get(Ore.Grade.RICH).get(), "m", """
        ...
        // gems
        var amethystEntry = createOreEntry("amethyst", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.AMETHYST), TFCItems.GEMS.get(Ore.AMETHYST).get(), "n", """
        ...
        var diamondEntry = createOreEntry("diamond", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.DIAMOND), TFCItems.GEMS.get(Ore.DIAMOND).get(), "o", """
        ...
        var emeraldEntry = createOreEntry("emerald", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.EMERALD), TFCItems.GEMS.get(Ore.EMERALD).get(), "p", """
        ...
        var lapisLazuliEntry = createOreEntry("lapis_lazuli", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.LAPIS_LAZULI), TFCItems.GEMS.get(Ore.LAPIS_LAZULI).get(), "q", """
        ...
        var opalEntry = createOreEntry("opal", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.OPAL), TFCItems.GEMS.get(Ore.OPAL).get(), "r", """
                Opal is a decorative **Gemstone**. \s
                \\
                It can be found in **Sedimentary** and **Igneous Extrusive** rock beneath rivers above y=40.
                """);

        var pyriteEntry = createOreEntry("pyrite", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.PYRITE), TFCItems.GEMS.get(Ore.PYRITE).get(), "s", """
                Topaz is a decorative **Mineral**. \s
                \\
                It can be found in **Igneous Extrusive** and **Igneous Intrusive** rocks.
                """);

        var rubyEntry = createOreEntry("ruby", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.RUBY), TFCItems.GEMS.get(Ore.RUBY).get(), "t", """
                Ruby is a decorative **Gemstone**. \s
                \\
                It can be found in **Schist** and **Gneiss** rock below y=-10.
                """);

        var sapphireEntry = createOreEntry("sapphire", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.SAPPHIRE), TFCItems.GEMS.get(Ore.SAPPHIRE).get(), "u", """
        ...
        var topazEntry = createOreEntry("topaz", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.TOPAZ), TFCItems.GEMS.get(Ore.TOPAZ).get(), "v", """
                Topaz is a decorative **Mineral**. \s
                \\
                It can be found in **Sedimentary** and **Igneous Extrusive** rock beneath rivers above y=40.
                """);
        ...
        // coal
        var ligniteEntry = createOreEntry("lignite", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.LIGNITE), TFCItems.ORES.get(Ore.LIGNITE).get(), "w", """
        ...
        var bituminousCoalEntry = createOreEntry("bituminous_coal", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.BITUMINOUS_COAL), TFCItems.ORES.get(Ore.BITUMINOUS_COAL).get(), "x", """
                Bituminous Coal is a type of mid-grade **Coal** ore. \s
                \\
                It can be found in very large flat deposits near the surface in **Sedimentary** rocks.
                """);

        var anthraciteEntry = createOreEntry("anthracite", CoreTags.Items.CORE_ORE_MULTIBLOCK.get(CoreOres.ANTHRACITE), SpectrumItems.PURE_COAL.get(), "y", """
        ...
        var kaoliniteEntry = createOreEntry("kaolinite", CoreTags.Items.KAOLIN_CLAYS, TFCItems.KAOLIN_CLAY.get(), "z", """
        ...
        var bauxiteEntry = createOreEntry("bauxite", CoreTags.Items.CORE_ORE_MULTIBLOCK.get(CoreOres.BAUXITE), CoreItems.ORES.get(CoreOres.BAUXITE).get(), "A", """
        ...
        var graphiteEntry = createOreEntry("graphite", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.GRAPHITE), TFCItems.ORES.get(Ore.GRAPHITE).get(), "B", """
        ...
        var cinnabarEntry = createOreEntry("cinnabar", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.CINNABAR), TFCItems.ORES.get(Ore.CINNABAR).get(), "C", """
        ...
        var cryoliteEntry = createOreEntry("cryolite", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.CRYOLITE), TFCItems.ORES.get(Ore.CRYOLITE).get(), "D", """
        ...
        var saltpeterEntry = createOreEntry("saltpeter", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.SALTPETER), TFCItems.ORES.get(Ore.SALTPETER).get(), "E", """
                Saltpeter is a **Mineral** which can be ground in the **Quern**, and then used in the crafting of **Gunpowder**. \s
                \\
                It can be found in very large flat deposits near the surface in **Sedimentary** rocks.
                """);

        var sulfurEntry = createOreEntry("sulfur", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.SULFUR), TFCItems.ORES.get(Ore.SULFUR).get(), "F", """
        ...
        var sylviteEntry = createOreEntry("sylvite", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.SYLVITE), TFCItems.ORES.get(Ore.SYLVITE).get(), "G", """
        ...
        var boraxEntry = createOreEntry("borax", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.BORAX), TFCItems.ORES.get(Ore.BORAX).get(), "H", """
        ...
        var gypsumEntry = createOreEntry("gypsum", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.GYPSUM), TFCItems.ORES.get(Ore.GYPSUM).get(), "I", """
                Gypsum is a decorative **Mineral** which can be used to make **Plaster**. \s
                \\
                It can be found in very large flat deposits near the surface in **Sedimentary** rocks.
                """);

        var haliteEntry = createOreEntry("halite", CoreTags.Items.TFC_ORE_MULTIBLOCK.get(Ore.HALITE), TFCItems.ORES.get(Ore.HALITE).get(), "J", """
                 Halite is a **Mineral** which can be ground in the **Quern** to make **Salt**, which is an important **Preservative**.\s
                 \\
                 It can be found in very large flat deposits near the surface in **Sedimentary** rocks.
                \s""");

        var meteoricIronEntry = createOreEntry("meteoric_iron", CoreTags.Items.CORE_ORE_MULTIBLOCK.get(CoreOres.METEORIC_IRON), CoreItems.ORES.get(CoreOres.METEORIC_IRON).get(), "K", """
        ...
        var quartzEntry = createOreEntry("quartz", CoreTags.Items.CORE_ORE_MULTIBLOCK.get(CoreOres.QUARTZ), Items.QUARTZ.asItem(), "L", """
    ...
    {
        return this.add(new OreEntry(this, id, item, text, tag).generate(symbol));
    }
