...
public class OresCategory extends CategoryProvider {
    ...
    protected void generateEntries() {
        ...
        var garnieriteEntry = createOreEntry(
                ...
                It can be found at elevations below y=0. 
                It can be found primarily in *Gabbro* deep underground. 
                Smaller, rarer veins can also be found in any *Igneous Intrusive* rock.
                """
        );
        ...
        var galenaEntry = createOreEntry(
                ...
                "i",
                """
                Galena is an ore of Lead metal. It can be found...
                """
        );
        ...
        var diamondEntry = createOreEntry(
                ...
                It appears in thin vertical ore formations called *Kimberlite Pipes* which can be up to a hundred blocks tall. 
                It can only be found in *Gabbro*.
                """
        );
        ...
        var lapisLazuliEntry = createOreEntry(
                ...
                It can be found in large, but sparse veins in *Limestone* and *Marble*, between y=-20 and y=80.
                """
        );
        ...
        var opalEntry = createOreEntry(
                ...
                "r",
                """
                Opal is a decorative *Mineral*. \s
        ...
        var pyriteEntry = createOreEntry(
                ...
                "s",
                """
                WIP. Opal is a decorative *Mineral*. \s
                It can be found in *Sedimentary* and *Igneous Extrusive* rock beneath rivers above y=40.
                """
        );
        ...
        var rubyEntry = createOreEntry(
                ...
                "t",
                """
                Ruby is a decorative *Mineral*. \s
        ...
        var bauxiteEntry = createOreEntry(
                ...
                "A",
                """
                WIP. Kaolinite is a soft *Mineral* which is used in the construction of *Fire Clay*. \s
                It can be found spawning at high altitudes in Plateaus, Old Mountains, Rolling Hills, and Highlands, at a *temperature* of at least 18°C, with a *rainfall* of at least 300mm. 
                The *Blood Lily* flower grows on Kaolin clay.
                """
        );
        ...
        var cinnabarEntry = createOreEntry(
                ...
                It can be found in veins deep underground, in *Quartzite*, *Granite*, *Phyllite*, and *Schist*. \s
                """
        );
        ...
        var cryoliteEntry = createOreEntry(
                ...
                It can be found in veins deep underground, in *Granite*, and *Diorite*.
                """
        );
        ...
        var sylviteEntry = createOreEntry(
                ...
                It can be found in very large flat deposits near the surface in *Shale*, *Claystone* and *Chert*.
                """
        );
        ...
        var boraxEntry = createOreEntry(
                ...
                It can be found in very large flat deposits near the surface in *Claystone*, *Limestone*, and *Shale*.
                """
        );
