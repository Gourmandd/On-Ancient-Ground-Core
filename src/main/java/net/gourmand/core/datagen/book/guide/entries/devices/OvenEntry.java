...
public class OvenEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        // page 1: explain oven.
        this.page("page1", () -> BookTextPageModel.create().withText(this.context().pageText()).withTitle(this.context().pageTitle()));
        ...
        // page 2: multiblock.
        this.page("page2", () -> BookMultiblockPageModel.create().withText(this.context().pageText()).withMultiblockId(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "devices/oven")).withVisualizeButton(false));
        ...
        this.page("page4", () -> BookKnappingPageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(FirmaLife.MOD_ID, "knapping/clay_oven_bottom")));
        ...
        this.page("page5", () -> BookTextPageModel.create().withText(this.context().pageText()).withTitle(this.context().pageTitle()));
        ...
        this.page("page6", () -> BookKnappingPageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(FirmaLife.MOD_ID, "knapping/clay_oven_top")));
        ...
        this.page("page7", () -> BookTextPageModel.create().withText(this.context().pageText()).withTitle(this.context().pageTitle()));
        ...
        this.page("page8", () -> BookKnappingPageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(FirmaLife.MOD_ID, "knapping/clay_oven_chimney")));
        ...
        this.page("page9", () -> BookTextPageModel.create().withText(this.context().pageText()).withTitle(this.context().pageTitle()));
        ...
        // page 10: multiblock.
        this.page("page10", () -> BookMultiblockPageModel.create().withText(this.context().pageText()).withMultiblockId(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "devices/oven_showcase")).withVisualizeButton(false));
        ...
        this.page("page11", () -> BookTextPageModel.create().withText(this.context().pageText()).withTitle(this.context().pageTitle()));
        ...
        // page 12: multiblock.
        this.page("page12", () -> BookMultiblockPageModel.create().withText(this.context().pageText()).withMultiblockId(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "devices/oven_showcase_fired")).withVisualizeButton(false));
        ...
        this.page("page13", () -> BookCraftingRecipePageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(FirmaLife.MOD_ID, "crafting/oven_insulation")));
        ...
        // page 14: multiblock.
        this.page("page14", () -> BookMultiblockPageModel.create().withText(this.context().pageText()).withMultiblockId(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "devices/oven_insulated")).withVisualizeButton(false));
