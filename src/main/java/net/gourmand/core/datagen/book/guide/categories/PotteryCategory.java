...
import net.gourmand.core.datagen.book.guide.entries.gettingStarted.ClayEntry;
import net.gourmand.core.datagen.book.guide.entries.gettingStarted.PitKilnEntry;
import net.gourmand.core.datagen.book.guide.entries.metalworking.HeatingEntry;
...
public class PotteryCategory extends CategoryProvider
{
    ...
    {
        return new String[]{"__g_h___c____", "__i_l_______d", "j_k_q__a_b__e", "__n_m_______f", "__o_p_s_t_r__"};
    }
    ...
    protected void generateEntries()
    {
        ...
        var heating = this.add(new HeatingEntry(this).generate("t"));
    }
