...
public class BucketEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        this.page("page1", () -> BookSpotlightPageModel.create().withTitle(this.context().pageTitle()).withText(this.context().pageText()).withItem(Ingredient.of(TFCItems.WOODEN_BUCKET)));
        ...
        this.page("page2", () -> BookCraftingRecipePageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(TerraFirmaCraft.MOD_ID, "crafting/wooden_bucket")));
        ...
        this.page("page3", () -> BookSpotlightPageModel.create().withTitle(this.context().pageTitle()).withText(this.context().pageText()).withItem(Ingredient.of(CoreItems.WROUGHT_IRON_BUCKET.get())));
        ...
        this.page("page4", () -> BookAnvilWorkingPageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "anvil/metal/bucket/wrought_iron")));
        ...
        this.page("page5", () -> BookSpotlightPageModel.create().withTitle(this.context().pageTitle()).withText(this.context().pageText()).withItem(Ingredient.of(TFCItems.BLUE_STEEL_BUCKET)));
        ...
        this.page("page6", () -> BookAnvilWorkingPageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(TerraFirmaCraft.MOD_ID, "anvil/metal/bucket/blue_steel")));
