...
public class FermentedTraitEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        this.page("page2", () -> BookBarrelSealedPageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath(FirmaLife.MOD_ID, "barrel_sealed/ferment_white_grapes")).withRecipeId2(ResourceLocation.fromNamespaceAndPath(FirmaLife.MOD_ID, "barrel_sealed/ferment_red_grapes")));
