...
public class FireEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        this.page("page2", () -> BookCraftingRecipePageModel.create().withText(this.context().pageText()).withRecipeId1("tfc:crafting/firestarter"));
        ...
        this.page("page3", () -> BookSpotlightPageModel.create().withText(this.context().pageText()).withItem(Ingredient.of(TFCBlocks.FIREPIT.asItem())));
        ...
        // page 4: multiblock.
        this.page("page4", () -> BookMultiblockPageModel.create().withText(this.context().pageText()).withMultiblockId(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "getting_started/fire_pit")).withVisualizeButton(false));
        ...
        // page 6: multiblock.
        this.page("page6", () -> BookImagePageModel.create().withText(this.context().pageText()).withImages(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "textures/book/getting_started/fire_pit_interface.png")));
