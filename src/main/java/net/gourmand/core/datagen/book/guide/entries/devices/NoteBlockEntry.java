...
public class NoteBlockEntry extends EntryProvider
{
    ...
    protected void generatePages()
    {
        ...
        this.page("page1", () -> BookSpotlightPageModel.create().withTitle(this.context().pageTitle()).withText(this.context().pageText()).withItem(Ingredient.of(Blocks.NOTE_BLOCK)));
        ...
        // page 2: crafting.
        this.page("page2", () -> BookCraftingRecipePageModel.create().withText(this.context().pageText()).withRecipeId1(ResourceLocation.fromNamespaceAndPath("minecraft", "note_block")));
        ...
        this.page("page3", () -> BookTextPageModel.create().withTitle("Note Block Timbre").withText(this.context().pageText()));
        ...
        this.page("page4", () -> BookTextPageModel.create().withTitle("Note Block Timbre").withText(this.context().pageText()));
