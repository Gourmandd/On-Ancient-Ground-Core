...
public class CuttingRecipes extends CuttingRecipeGen {
    ...
    public void cuttingRecipes(){
        ...
        for (DyeColor color : DyeColor.values()){
            ...
            create(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "cutting/framed_glass/" + color.getSerializedName()), b -> b.duration(50)
                    .require(framedGlassBlock)
                    .output(framedGlassPane, 16)
            );

            create(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "cutting/glass/" + color.getSerializedName()), b -> b.duration(50)
                    .require(glassBlock)
                    .output(glassPane, 16)
            );

            create(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "cutting/lead_glass/" + color.getSerializedName()), b -> b.duration(50)
                    .require(leadGlassBlock)
                    .output(leadGlassPane, 16)
            );
        }
        // clear glass
        create(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "cutting/framed_glass/clear"), b -> b.duration(50)
                .require(CategoryUtil.Glass.QUARK_CLEAR_GLASS.value())
                .output(CategoryUtil.Glass.QUARK_CLEAR_GLASS_PANE.value(), 16)
        );

        create(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "cutting/glass/clear"), b -> b.duration(50)
                .require(Blocks.GLASS)
                .output(Blocks.GLASS_PANE, 16)
        );

        create(ResourceLocation.fromNamespaceAndPath(AncientGroundCore.MOD_ID, "cutting/lead_glass/clear"), b -> b.duration(50)
