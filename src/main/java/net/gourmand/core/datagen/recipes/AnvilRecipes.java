    ...
    default void anvilRecipes()
    {
        ...
        for (CoreMetals.MetalType metal : CoreMetals.MetalType.values())
        {
            anvil(
                    ...
                    metal.tier(),
                    List.of(ForgeRule.HIT_LAST, ForgeRule.HIT_SECOND_LAST, ForgeRule.HIT_THIRD_LAST),
            ...
            anvil(
                    ...
                    metal.tier(),
                    List.of(ForgeRule.BEND_LAST, ForgeRule.DRAW_SECOND_LAST, ForgeRule.DRAW_THIRD_LAST),
        ...
        anvil(
                ...
                List.of(ForgeRule.BEND_THIRD_LAST, ForgeRule.BEND_SECOND_LAST, ForgeRule.HIT_LAST),
        ...
        anvil(
                ...
                Metal.BRONZE.tier(),
                List.of(ForgeRule.BEND_LAST, ForgeRule.BEND_SECOND_LAST, ForgeRule.HIT_THIRD_LAST),
        ...
        anvil(
                TFCItems.METAL_ITEMS.get(Metal.BRASS).get(Metal.ItemType.DOUBLE_SHEET).get(),
                Metal.BRONZE.tier(),
                List.of(ForgeRule.BEND_LAST, ForgeRule.PUNCH_SECOND_LAST, ForgeRule.HIT_THIRD_LAST),
        ...
        anvil(
                ...
                Metal.STEEL.tier(),
                List.of(ForgeRule.BEND_LAST, ForgeRule.PUNCH_SECOND_LAST, ForgeRule.UPSET_THIRD_LAST),
