...
import net.gourmand.AncientGroundCore.registry.blockentities.CoreLoomBlockEntity;
import net.gourmand.AncientGroundCore.registry.blockentities.CoreSluiceBlockEntity;
import net.gourmand.AncientGroundCore.registry.blocks.CoreDecorationBlockHolder;
import net.gourmand.AncientGroundCore.registry.blocks.CoreLoomBlock;
import net.gourmand.AncientGroundCore.registry.blocks.CoreShelfBlock;
import net.gourmand.AncientGroundCore.registry.blocks.CoreToolRackBlock;
